...
if resp.upper() == 'B':
    ...
    print("Resposta errada tente denovo")
    resp = input("Digite a resposta da pergunta 1 (A/B/C/D): ")
    if resp.upper() == 'B':
        pontos += 2
        print("Certa Resposta!!")
...
if pontos >= 75:
    print("Se é o bixão mesmo em doido")
elif pontos == 0:
    print("PHATETIC!!")
elif pontos < 40:
    print("Acerto a miseravi")
elif pontos < 75:
    print("Bom não é das melhores mas pelo menos é trabalho honesto")